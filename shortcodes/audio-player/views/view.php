...
if ( ! function_exists( 'sc_ap_render' ) ) {
	...
	function sc_ap_render( $atts ) {
		...
		// per-instance `fw_ext_shortcodes_enqueue_static:audio_player` action is fired from a scan whose
		...
		if ( function_exists( 'fw_sc_design_enqueue_now' ) ) { fw_sc_design_enqueue_now( 'audio_player', $design ); }
