...
if ( ! function_exists( 'sc_cal_render' ) ) {
	...
	function sc_cal_render( $atts ) {
		...
		// per-instance `fw_ext_shortcodes_enqueue_static:calendar` action is fired from a scan whose
		...
		if ( function_exists( 'fw_sc_design_enqueue_now' ) ) { fw_sc_design_enqueue_now( 'calendar', $design ); }
