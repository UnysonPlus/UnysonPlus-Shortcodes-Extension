            ...
            'preset_group' => [
                ...
                'options' => [
                    ...
                    'frame_preset' => [
                        ...
                        'label'        => __( 'Frame (Box Preset)', 'fw' ),
                        'desc'         => __( 'Optional outer frame wrapped around the table, using a Box Preset (Theme Settings → Components → Box Presets). Stacks on top of the Table Preset.', 'fw' ),
