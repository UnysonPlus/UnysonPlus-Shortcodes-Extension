...
if ( ! function_exists( 'sc_bq_render' ) ) {
	...
	function sc_bq_render( $atts ) {
		...
		// per-instance `fw_ext_shortcodes_enqueue_static:blockquote` action is fired from a scan whose
		...
		if ( function_exists( 'fw_sc_design_enqueue_now' ) ) { fw_sc_design_enqueue_now( 'blockquote', $design ); }
