...
if ( ! function_exists( 'sc_hs_render' ) ) {
	...
	function sc_hs_render( $atts ) {
		...
		// per-instance `fw_ext_shortcodes_enqueue_static:image_hotspots` action is fired from a scan whose
		...
		if ( function_exists( 'fw_sc_design_enqueue_now' ) ) { fw_sc_design_enqueue_now( 'image_hotspots', $design ); }
