...
/**
 * Card — Diagonal Split. Image on top with a diagonal clipped edge flowing into
 * the content (CSS clip-path). Image-top structure.
 *
...
$article_class = 'posts__card posts__card--diagonal';
