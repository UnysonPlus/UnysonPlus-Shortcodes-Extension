...
/**
 * Card — Magazine Cover (image fills the card; content sits in a solid band at
 * the bottom). Distinct from `gradient` by the solid title band.
 *
...
<article class="<?php echo esc_attr( $article_class ); ?>" role="listitem">
    ...
    <?php endif; ?>
    <div class="posts__cover-band entry-content">
