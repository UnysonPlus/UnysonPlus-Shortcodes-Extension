...
/**
 * Card — Gradient Overlay (Magazine).
 *
 * Image fills the card; a dark gradient sits at the bottom; content is layered
 * over it. Distinct from `overlay` by the gradient scrim + hover zoom (CSS).
 *
 * @var array   $sc_atts
 * @var WP_Post $sc_post
 * @var string  $sc_style
...
$article_class = 'posts__card posts__card--gradient';
...
<article class="<?php echo esc_attr( $article_class ); ?>" role="listitem">
    ...
    <div class="posts__gradient-scrim" aria-hidden="true"></div>

    <div class="posts__gradient-body entry-content">
