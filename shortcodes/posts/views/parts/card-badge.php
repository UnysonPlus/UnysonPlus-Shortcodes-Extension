...
/**
 * Card — Bordered Badge. An outlined card with a ribbon "badge" notch in the
 * top-right corner (CSS). Image-top structure.
 *
...
$article_class = 'posts__card posts__card--badge';
...
<article class="<?php echo esc_attr( $article_class ); ?>" role="listitem">
    <span class="posts__badge-notch" aria-hidden="true"></span>
