...
/**
 * Card — Glassmorphism. Image fills the card; the content sits in a frosted,
 * blurred glass panel near the bottom (CSS backdrop-filter, with a solid
 * fallback). Distinct from gradient/cover by the translucent blur panel.
 *
...
$article_class = 'posts__card posts__card--glass';
...
<article class="<?php echo esc_attr( $article_class ); ?>">
    ...
    <?php endif; ?>
    <div class="posts__glass-panel entry-content">
