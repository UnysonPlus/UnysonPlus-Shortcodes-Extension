...
if ( ! function_exists( 'sc_ab_render' ) ) {
	...
	function sc_ab_render( $atts ) {
		...
		// per-instance `fw_ext_shortcodes_enqueue_static:author_box` action is fired from a scan whose
		...
		if ( function_exists( 'fw_sc_design_enqueue_now' ) ) { fw_sc_design_enqueue_now( 'author_box', $design ); }
