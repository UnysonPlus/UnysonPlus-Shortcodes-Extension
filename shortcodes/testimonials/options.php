                ...
                'options' => [
                    'testimonials' => [
                        ...
                        'popup-options' => [
                            ...
                            'extra' => [
                                'label'         => __('Extra Texts', 'fw'),
                                'desc'          => __('Optional stat / result lines shown at the card footer (e.g. “Total savings” → “$14,200”, or just “40% more closes”).', 'fw'),
                                'help'          => __('Each row is a small muted label with an emphasized value beneath it. Placed via the "Extra Texts" slot in Card Rows (defaults to the card footer). Add as many as you like; leave the label blank for a value-only line.', 'fw'),
                                'type'          => 'addable-popup',
                                'template'      => '{{= value || label }}',
                                'popup-options' => [
                                    'label' => [
                                        'label' => __('Label', 'fw'),
                                        'desc'  => __('Muted caption above the value (e.g. “Total savings”). Optional.', 'fw'),
                                        'type'  => 'text',
                                    ],
                                    'value' => [
                                        'label' => __('Value', 'fw'),
                                        'desc'  => __('Emphasized value (e.g. “$14,200” or “40% more closes”).', 'fw'),
                                        'type'  => 'text',
                                    ],
                                ],
                            ],
