...
// per-instance `fw_ext_shortcodes_enqueue_static:avatar` action is fired from a scan whose
...
if ( function_exists( 'fw_sc_design_enqueue_now' ) ) { fw_sc_design_enqueue_now( 'avatar', $design ); }
